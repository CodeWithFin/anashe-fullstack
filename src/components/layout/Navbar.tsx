...
export const Navbar = ({ onAuthClick }: { onAuthClick?: () => void }) => {
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed inset-0 bg-black/80 z-[998] transition-opacity duration-500 lg:hidden",
      ...
      <div 
        className={cn(
          "fixed top-0 right-0 w-[300px] h-full z-[999] flex flex-col p-12 gap-8 transition-transform duration-500 ease-out lg:hidden border-l border-white/10 shadow-2xl",
